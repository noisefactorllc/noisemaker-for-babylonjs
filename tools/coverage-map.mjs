...
export async function buildCoverageMap ({ log = () => {} } = {}) {
  ...
  return {
    _comment: 'Generated by node tools/coverage-map.mjs — GAP-004 acceptance map: every catalogued effect branch bound to fixture evidence (parity/ledger.json, parity/mode-coverage.json, parity/external-input-grades.json) or an explicit exclusion. Counts retain skipped and refused cases. Re-derived, never hand-edited.',
